...
public class Pallet {
    ...
    private final PalletPosition[][] positions = {{new PalletPosition(), new PalletPosition()}, {new PalletPosition(), new PalletPosition()}};
    ...
    public boolean addBox(Box box, int position, int level) {
        ...
        if (position == 3) {
            return positions[1][1].addBoxToPalletPosition(box, level);
        }
